...
namespace VehicleBehaviour
{
    ...
    public class WheelVehicle : MonoBehaviour
    {
        ...
        public bool uiButtonAcelerarApretado;
        ...
        void Start()
        {
            ...
            uiButtonAcelerarApretado = false;
        ...
        */
        ...
        public void pulsarAcelerar()
        {
            Debug.Log("ACELERA");
        }

        public void noPulsarAcelerar()
        {
            Debug.Log("no acelera");
        }
